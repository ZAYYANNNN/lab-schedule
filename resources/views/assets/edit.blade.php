            ...
            <form action="{{ route('assets.update', $asset->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="lab_id" id="lab_id"
                        ...
                        @foreach($labs as $lab)
                            <option value="{{ $lab->id }}" {{ $asset->lab_id == $lab->id ? 'selected' : '' }}>{{ $lab->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ $asset->nama }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_aset" id="kode_aset" value="{{ $asset->kode_aset }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="jumlah" id="jumlah" value="{{ $asset->jumlah }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        min="1" required>
