                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input name="prodi" class="w-full border p-2 rounded mb-3" x-model="searchProdi"
                            @input="filterProdi()" autocomplete="off" required>
            ...
            @forelse($admins as $admin)
                <div class="border-b py-3 flex justify-between items-center">
                    <div>
                        ...
                        <span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded ml-2">{{ $admin->prodi }}</span>
                    </div>
            ...
            <div @click.outside="openEdit = false" class="bg-white w-[30rem] p-6 rounded-xl shadow-lg">
                ...
                <form :action="`/users/${editData.id}`" method="POST">
                    ...
                    <div class="mb-3 relative">
                        <label class="block">Prodi</label>
                        <input name="prodi" class="w-full border p-2 rounded" x-model="editData.prodi"
                            @input="filterProdi(true)" autocomplete="off" required>
