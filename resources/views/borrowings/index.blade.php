                    ...
                    <div
                        ...
                        <div class="px-8 py-7 border-b border-slate-50 bg-slate-50/50">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h2 class="font-black text-slate-800 uppercase text-xs tracking-[0.2em]">Filter Laboratorium
                                </h2>
                            </div>
                                    ...
                                    @forelse ($borrowings as $b)
                                        <tr class="hover:bg-blue-50/30 transition-all duration-300 group">
                                            <td class="px-8 py-6">
                                                <div class="flex items-center gap-4">
                                                    <div
                                                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-white shadow-inner flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform duration-500">
                                                        <span class="material-symbols-outlined text-2xl">person</span>
                                                    </div>
                                                    <div>
                                                        <p
                                                            class="font-black text-slate-900 tracking-tight leading-none mb-1.5">
                                                            {{ $b->nama_peminjam }}</p>
                                                        <p
                                            ...
                                            <td class="px-8 py-6">
                                                <div>
                                                    <p
                                                        class="font-black text-slate-800 tracking-tight group-hover:text-blue-600 transition-colors mb-1.5">
                                                        {{ $b->asset->nama ?? 'Aset dihapus' }}</p>
                                                    <div class="flex items-center gap-2">
                                                        <span
                                                            class="material-symbols-outlined text-base text-blue-500 opacity-60">door_front</span>
                                                        <span
                                                            class="text-[11px] font-bold text-slate-500 truncate max-w-[150px]">{{ $b->lab->name }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-8 py-6">
                                                <div class="space-y-1.5">
                                                    <div class="flex items-center gap-2 text-slate-600">
                                                        ...
                                                        <span
                                                            class="text-[13px] font-black tracking-tight">{{ $b->borrow_date->format('d M Y') }}</span>
                                                    </div>
                                                    <div class="flex items-center gap-2 text-slate-400">
                                                        <span class="material-symbols-outlined text-base">history</span>
                                                        <span class="text-[11px] font-bold italic tracking-tight">Kembali:
                                                            {{ $b->return_date->format('d M Y') }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-8 py-6">
                                                ...
                                                @endphp
                                                <span
                                                    class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border shadow-sm {{ $colors[$b->status] ?? 'bg-slate-50 text-slate-600 border-slate-100' }}">
                                            ...
                                            <td colspan="5" class="px-8 py-24 text-center">
                                                <div class="flex flex-col items-center group">
                                                    <div
                                                        ...
                                                        <span
                                                            class="material-symbols-outlined text-5xl opacity-30 group-hover:text-blue-500 group-hover:opacity-100 transition-all duration-700">inventory</span>
                                                    </div>
                                                    <h3 class="text-slate-900 font-black text-xl tracking-tighter mb-2">
                                                        Tidak Ada Data Peminjaman</h3>
                                                    <p
                                                        class="text-slate-400 font-medium text-sm max-w-[320px] mx-auto tracking-tight leading-relaxed italic">
                                                        Catatan peminjaman barang belum tersedia dalam sistem saat ini.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
                                ...
                                <div class="mb-10 flex items-center justify-between">
                                    ...
                                    <div
                                        ...
                                        <span class="material-symbols-outlined text-3xl"
                                            x-text="editMode ? 'edit_document' : 'app_registration'"></span>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-8">
                                    <div class="grid grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div class="relative group">
                                                <span
                                                    class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-blue-500 transition-colors">person</span>
                                                <input type="text" name="nama_peminjam" x-model="form.nama_peminjam"
                                                    required
                                        ...
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">NIM</label>
                                            <div class="relative group">
                                                <span
                                                    class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-blue-500 transition-colors">id_card</span>
                                    ...
                                    <div class="grid grid-cols-2 gap-6">
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Mulai
                                                Pinjam</label>
                                        ...
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Rencana
                                                Kembali</label>
                                    ...
                                    <template x-if="editMode">
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Update
                                                Status</label>
                                            <div class="relative group">
                                                ...
                                                <span
                                                    class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 pointer-events-none">sync_alt</span>
                                            </div>
                                        </div>
                                    </template>
                                    ...
                                    <div>
                                        <label
                                            class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Catatan
                                            Tambahan</label>
                                        <textarea name="notes" x-model="form.notes" rows="3"
                                            placeholder="Contoh: Kondisi barang saat dipinjam..."
